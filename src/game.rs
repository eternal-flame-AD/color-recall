...
mod tests {
    ...
    fn test_srgb_conversion() {
        ...
        let sliders = RGBChooser::from_srgb(srgb);
        let srgb2 = RGBChooser::as_srgb(&RGBChooser, &sliders);
    ...
    fn test_hsv_conversion() {
        let srgb = Srgb::new(0.5, 0.5, 0.5);
        let sliders = HSVChooser::from_srgb(srgb);
        let srgb2 = HSVChooser::as_srgb(&HSVChooser, &sliders);
        assert_eq!(srgb, srgb2);
    }
    ...
    fn test_hsl_conversion() {
        let srgb = Srgb::new(0.5, 0.5, 0.5);
        let sliders = HSLChooser::from_srgb(srgb);
        let srgb2 = HSLChooser::as_srgb(&HSLChooser, &sliders);
        assert_eq!(srgb, srgb2);
    }
    ...
    fn test_lab_conversion() {
        let srgb = Srgb::new(0.5, 0.5, 0.5);
        let sliders = LABChooser::from_srgb(srgb);
        let srgb2 = LABChooser::as_srgb(&LABChooser, &sliders);
        assert_eq!(srgb, srgb2);
    }
    ...
    fn test_xyz_conversion() {
        let srgb = Srgb::new(0.5, 0.5, 0.5);
        let sliders = XYZChooser::from_srgb(srgb);
        let srgb2 = XYZChooser::as_srgb(&XYZChooser, &sliders);
        assert_eq!(srgb, srgb2);
    }
    ...
    fn test_distance() {
        let challenge = ColorChallenge {
            target: Srgb::new(0.5, 0.5, 0.5),
        };
        let distance = challenge.compute_distance(Srgb::new(0.5, 0.5, 0.5));
